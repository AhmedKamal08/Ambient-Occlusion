...
int main(int argc, char **argv)
{
	...
	cout << "Press O and P to increase and decrese the radius" << endl;
	cout << "Press L and K to increase and decrese the intensity" << endl;
	cout << "Press M and N to increase and decrese the kernalSize" << endl;
	cout << "Press F2 to Toggle between SSAO and SSAO separble" << endl;
